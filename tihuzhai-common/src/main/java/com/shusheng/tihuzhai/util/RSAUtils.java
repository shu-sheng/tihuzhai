...
public abstract class RSAUtils {
    ...
    private static synchronized KeyPair generateKeyPair() {
        try {
            ...
            LOGGER.error(
                    "RSAUtils#KEY_PAIR_GEN is null, can not generate KeyPairGenerator instance.", ex);
        }
        return null;
    }
    ...
    public static String decryptString(PrivateKey privateKey, String encrypttext) {
        ...
        try {
            ...
            LOGGER.error(String.format("\"%s\" Decryption failed. Cause: %s", encrypttext, ex
                    .getCause().getMessage()));
        }
        return null;
    }
    ...
    public static PublicKeyMap getPublicKeyMap() {
        ...
        publicKeyMap.setExponent(new String(Hex.encodeHex(rsaPublicKey.getPublicExponent()
                .toByteArray())));
        return publicKeyMap;
    }
}